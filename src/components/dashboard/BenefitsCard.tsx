        ...
        <div className="col-span-full space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100/50 border-none rounded-2xl p-6 flex flex-col items-center justify-center text-center shadow-sm">
                    <span className="text-3xl font-bold text-green-700">{formatCurrency(netProfit)}</span>
                    <span className="text-sm text-green-600 font-semibold mt-2">Ganancia Neta</span>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 border-none rounded-2xl p-6 flex flex-col items-center justify-center text-center shadow-sm">
                    <span className="text-3xl font-bold text-blue-700">{formatCurrency(totalRevenue)}</span>
                    <span className="text-sm text-blue-600 font-semibold mt-2">Ingresos Totales</span>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 border-none rounded-2xl p-6 flex flex-col items-center justify-center text-center shadow-sm">
                    <span className="text-3xl font-bold text-purple-700">{profitMargin.toFixed(1)}%</span>
                    <span className="text-sm text-purple-600 font-semibold mt-2">Margen de Beneficio</span>
                </div>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 border-none rounded-2xl p-6 flex flex-col items-center justify-center text-center shadow-sm">
                    <span className="text-3xl font-bold text-orange-700">{totalProjects}</span>
                    <span className="text-sm text-orange-600 font-semibold mt-2">Proyectos Activos</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 bg-white p-6 rounded-2xl border shadow-sm">
                <div>
                    <div className="flex justify-between items-center mb-3">
                        ...
                        <span className="text-xs bg-gray-100 px-3 py-1 rounded-full font-medium">Cerca</span>
                    </div>
                ...
                <div>
                    <div className="flex justify-between items-center mb-3">
                        ...
                        <span className="text-xs text-green-600 font-bold">+{monthlyGrowth}%</span>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-4 flex flex-col items-center justify-center">
                        <span className="text-2xl font-bold text-gray-900">{formatCurrency(projectedAnnualProfit)}</span>
            ...
            <div className="bg-white p-6 rounded-2xl border shadow-sm">
                ...
                <div className="space-y-3 text-sm">
                    ...
                    <div className="border-t pt-3 mt-3 flex justify-between">
                        ...
                        <span className="font-bold text-green-600 text-base">{formatCurrency(netProfit)}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 flex gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-yellow-700">El margen está cerca del objetivo. Considera optimizar costos o renegociar precios.</p>
                </div>
            </div>
        </div>
    );
