...
const getPlaceholder = (type: string) => {
    switch (type) {
        case "email": return "contacto@empresa.com";
        case "address": return "Av. Winston Churchill #12";
        case "website": return "https://www.empresa.com";
        case "phone":
        default: return "809-555-5555";
    }
};
...
export default function AddBeneficiaryModal({
    ...
    const onSubmit = async (data: CreateBeneficiaryBody) => {
        ...
        try {
            const payload = {
                ...data,
                creditLimit: data.creditLimit ? Number(String(data.creditLimit).replace(/,/g, '')) : undefined,
            };
                            ...
                            {fields.map((field, index) => (
                                <div key={field.id} className="flex gap-3">
                                    ...
                                    <input
                                        ...
                                        placeholder={getPlaceholder(watchedContacts?.[index]?.type || "phone")}
                                    />
                                    <button
                                        type="button"
