          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <div>
                ...
                <input
                  {...register("calleEmpresa")}
                  placeholder=" Av. Pedro Rivera"
                  className="p-2 border rounded w-full"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  {...register("municipioEmpresa")}
                  placeholder="Jarabacoa"
                  className="p-2 border rounded w-full"
                />
              </div>
              <div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {errors.cedulaRepresentante && (
                  <span className="text-red-500 text-xs block mt-1">
                    {errors.cedulaRepresentante.message}
                  </span>
                )}
              </div>
              <div>
                ...
                <input
                  {...register("pasaporteRepresentante")}
                  placeholder=" CD987654"
                  className="p-2 border rounded w-full"
                />
              </div>
              <div>
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <input
                  {...register("calleRepresentante")}
                  placeholder="Calle"
                  className="p-3 border rounded w-full"
                />
                <input
                  {...register("casaRepresentante")}
                  placeholder="Casa No."
                  className="p-3 border rounded w-full"
                />
                <input
                  {...register("aptoRepresentante")}
                  placeholder="Apto."
                  className="p-3 border rounded w-full"
                />
                <input
                  {...register("residencialRepresentante")}
                  placeholder="Residencial"
                  className="p-3 border rounded w-full"
                />
                <input
                  {...register("sectorRepresentante")}
                  placeholder="Sector"
                  className="p-3 border rounded w-full"
                />
                <input
                  {...register("municipioRepresentante")}
                  placeholder="Municipio"
                  className="p-3 border rounded w-full"
                />
                <select
                  {...register("provinciaRepresentante")}
                  className="p-2 border rounded w-full"
                >
                  <option value="">Seleccione Provincia</option>
                  <option value="Azua">Azua</option>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                {errors.localComercial && (
                  <span className="text-red-500 text-xs block mt-1">
                    {errors.localComercial.message}
                  </span>
                )}
              </div>
            </div>
