...
export default function CreateProjectPage() {
    ...
    const updateCategoryAmount = (id: string, amount: number) => {
        ...
        setBudgetCategories(prev =>
            prev.map(cat =>
                cat.id === id
                    ? { ...cat, amount, percentage: budget > 0 ? (amount / budget) * 100 : 0 }
                    : cat
            )
        );
    };
    ...
    return (
        <div className="flex min-h-screen w-full bg-gray-50">
            <AppSidebar currentView="dashboard" />
                ...
                <div className="min-h-screen bg-white p-8">
                    <div className="max-w-7xl mx-auto space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">Complete la información básica del proyecto</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white border border-gray-200 rounded-lg p-6">
                                <div className="flex items-center gap-2 mb-4">
                                    <h2 className="text-lg font-semibold text-gray-900">Presupuesto y Cronograma</h2>
                                </div>
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-6">
                            <div className="flex items-center gap-2 mb-4">
                                <h2 className="text-lg font-semibold text-gray-900">Documento de Presupuesto</h2>
                            </div>
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-6">
                            <div className="flex items-center gap-2 mb-4">
                                <h2 className="text-lg font-semibold text-gray-900">Distribución del Presupuesto por Categorías</h2>
                            </div>
                            <p className="text-sm text-gray-600 mb-4">
                                Asigne el consumo del presupuesto por categorías (Total: {totalPercentage.toFixed(1)}%)
                            </p>
                                    ...
                                    <div key={category.id} className="grid grid-cols-12 gap-2 items-center">
                                        ...
                                        <div className="col-span-3">
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    updateCategoryPercentage(category.id, parseFloat(e.target.value) || 0)
                                                }
                                                placeholder="0"
