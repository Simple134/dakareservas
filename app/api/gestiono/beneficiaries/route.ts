...
import type { BeneficiaryQueryParams, CreateBeneficiaryBody } from '@/src/types/gestiono';
...
export async function GET(request: NextRequest) {
    try {
        ...
        if (searchParams.has('withContacts')) params.withContacts = searchParams.get('withContacts') as 'true' | 'false';
        if (searchParams.has('withTaxData')) params.withTaxData = searchParams.get('withTaxData') as 'true' | 'false';
