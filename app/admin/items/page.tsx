                        ...
                        items.filter((item) => {
                          ...
                          const matchesSubcategory =
                            itemSubcategoryFilter ===
                              "Todas las subcategorías" ||
                            item.subcategory === itemSubcategoryFilter;
                          return (
                            matchesSearch &&
                            matchesCategory &&
                            matchesSubcategory
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                      Distribución de ítems según categoría
                    </p>
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                      Top 5 ítems por frecuencia de uso
                    </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                      Porcentaje de ítems por categoría
                    </p>
                    <div className="flex items-center justify-between">
                      <CategoryPieChart
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                      Los ítems que más se han usado en proyectos
                    </p>
