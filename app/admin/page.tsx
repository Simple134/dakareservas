...
function AdminPageContent() {
    ...
    const handleUpdateUser = async (updatedData: Partial<UserViewModel> & Partial<Tables<"persona_fisica">> & Partial<Tables<"persona_juridica">>) => {
        ...
        showConfirm(
            ...
            async () => {
                ...
                try {
                    ...
                    showAlert(
                        "Error",
                        "Error eliminando reserva: " + err.message,
                        "error",
                    );
                } finally {
                    setUpdatingStatus(false);
    ...
    const handleUpdatePaymentStatus = async (
        ...
        try {
            ...
            showAlert(
                "Error",
                "Error actualizando estado de pago: " + error.message,
                "error",
            );
        } finally {
            setUpdatingStatus(false);
    ...
    const handleUpdatePaymentMethod = async (
        ...
        try {
            ...
            showAlert(
                "Error",
                "Error actualizando método de pago: " + error.message,
                "error",
            );
        } finally {
            setUpdatingStatus(false);
    ...
    const handleUploadQuotation = async () => {
        ...
        try {
            ...
            showAlert(
                "Error",
                "Error subiendo cotización: " + error.message,
                "error",
            );
        } finally {
            setUpdatingStatus(false);
        ...
        showConfirm(
            ...
            async () => {
                ...
                try {
                    ...
                    showAlert(
                        "Error",
                        "Error eliminando cotización: " + error.message,
                        "error",
                    );
                } finally {
                    setUpdatingStatus(false);
